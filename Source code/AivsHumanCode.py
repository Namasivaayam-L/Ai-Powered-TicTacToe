...
import sys
from aiMove import *
class AivsHuman(QMainWindow,ai):
    flag=0
    ...
    def onClick(self,index):
        ...
        if index!=11:
            if AivsHuman.flag==0:
                self.resultLabel.setText('Select X or O Please')
            else:
                self.resultLabel.setText('All the Best!!!')
                ...
                if self.aiMove != 10 and self.aiMove !=0:    
    ...
    def __init__(self):
        super(AivsHuman,self).__init__()
        loadUi("C:\\Users\\NAMASIVAAYAM\\Documents\\Mini Project 3rd Sem\\PYQT5 GUI\\1vAi.ui",self)
